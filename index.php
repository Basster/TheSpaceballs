    ...
    <td align="center" valign="middle"><table width="802" height="602" cellspacing="0" cellpadding="0" class="content">
        <tr>
          <td align="left" valign="top"><div id="container">
              <div id="logo"><a href="spaceballs-game.php"><img src="spaceballs-the-game_logo.jpg" alt="Spaceballs The Game Logo" width="360" height="80" border="0"></a></div>
              <div id="text1">
              ...
              <div id="startbutton"><a href="spaceballs-game.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('start-mission','','button-down_start-mission.gif',1)"><img src="button-up_start-mission.gif" alt="Start Mission" name="start-mission" width="136" height="32" border="0"></a></div>
